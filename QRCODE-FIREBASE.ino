...
const char* ssid = "GEFIE";         
const char* pass = "@F4bul0s0@$"; 

#define FIREBASE_HOST "https://idealab-37bc9-default-rtdb.firebaseio.com/"    //substitua "Link_do_seu_banco_de_dados" pelo link do seu banco de dados 
#define FIREBASE_AUTH "WwD4ZwAEH9PrqHZ55qVUA9faSK3ifp9gBBgQLfEX"
  ...
  if (cam.jpg2rgb(fb, &image_rgb))
  {
    ...
    if (res.status) //Se conseguir decodificar a imagem mostra os dados na tela
    {
      ...
      if(trava == 0){
       ...
       Firebase.pushString("/QRCODE", res.payload); //Insere o texto do QRCODE no banco de dados do FireBase na pasta QRCODE
      }
